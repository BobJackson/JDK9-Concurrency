package com.wangyousong.concurrency.ch3.recipe04;
...
public class FileSearch implements Runnable {
     ...
     * execution will be divided in three phases
     ...
     * @param fileExtension Extension of the files we are searching for
